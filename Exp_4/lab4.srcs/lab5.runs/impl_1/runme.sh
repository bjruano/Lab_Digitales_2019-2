...
HD_PWD='C:/Users/NBJSWETT/Desktop/COSAS PUC/VIII Semestre/Laboratorio de Sistemas Digitales/Lab_Digitales_2019-2/Exp_4/lab4.srcs/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculadora_monedas.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculadora_monedas.tcl -notrace
