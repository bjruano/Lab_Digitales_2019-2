...
HD_PWD='D:/Lab_Digitales/Lab_Digitales_2019-2/Exp_4/lab4.srcs/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_with_button.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_with_button.tcl -notrace
