...
synth_design -top calculadora_monedas -part xc7a35tcpg236-1 -effort_level quick


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef calculadora_monedas.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file calculadora_monedas_utilization_synth.rpt -pb calculadora_monedas_utilization_synth.pb"
