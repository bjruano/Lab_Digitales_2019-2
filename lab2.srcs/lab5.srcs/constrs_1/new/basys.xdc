...
#Pmod Header JB
#Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {val_selected[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[0]}]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {val_selected[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[1]}]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {val_selected[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[2]}]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {val_selected[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[3]}]
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {val_selected[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[4]}]
##Sch name = JB8
#set_property PACKAGE_PIN A17 [get_ports {val_selected[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[5]}]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports {val_selected[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[6]}]
##Sch name = JB10 
#set_property PACKAGE_PIN C16 [get_ports {val_selected[7]}]					
...
#Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {val_selected[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[0]}]
	set_property PULLUP true [get_ports {val_selected[0]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {val_selected[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[1]}]
	set_property PULLUP true [get_ports {val_selected[1]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {val_selected[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[2]}]
	set_property PULLUP true [get_ports {val_selected[2]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {val_selected[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {val_selected[3]}]
