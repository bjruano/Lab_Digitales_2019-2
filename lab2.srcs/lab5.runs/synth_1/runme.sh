...
HD_PWD='C:/Users/NBJSWETT/Desktop/lab2.srcs/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Wave_Selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Wave_Selector.tcl
