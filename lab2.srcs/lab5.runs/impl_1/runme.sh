...
HD_PWD='C:/Users/NBJSWETT/Desktop/lab2.srcs/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Wave_Selector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Wave_Selector.tcl -notrace
