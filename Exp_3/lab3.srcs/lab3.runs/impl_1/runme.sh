...
HD_PWD='C:/Users/NBJSWETT/Desktop/COSAS PUC/VIII Semestre/Laboratorio de Sistemas Digitales/Lab_Digitales_2019-2/Exp_3/lab3.srcs/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flujo_alto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flujo_alto.tcl -notrace
