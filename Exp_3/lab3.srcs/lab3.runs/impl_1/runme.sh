...
HD_PWD='D:/Lab_Digitales/Lab_Digitales_2019-2/Exp_3/lab3.srcs/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_manager.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_seg_manager.tcl -notrace
