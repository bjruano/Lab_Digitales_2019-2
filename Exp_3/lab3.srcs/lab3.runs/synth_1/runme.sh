...
HD_PWD='D:/Lab_Digitales/Lab_Digitales_2019-2/Exp_3/lab3.srcs/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_manager.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_seg_manager.tcl
