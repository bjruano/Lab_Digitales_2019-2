...
HD_PWD='C:/Users/NBJSWETT/Desktop/COSAS PUC/VIII Semestre/Laboratorio de Sistemas Digitales/Lab_Digitales_2019-2/Exp_3/lab3.srcs/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flujo_alto.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flujo_alto.tcl
