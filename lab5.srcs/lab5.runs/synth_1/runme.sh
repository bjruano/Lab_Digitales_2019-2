...
HD_PWD='D:/Lab_Digitales/lab5.srcs/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDs_mgmt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LEDs_mgmt.tcl
