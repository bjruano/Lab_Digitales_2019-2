...
HD_PWD='D:/Lab_Digitales/lab5.srcs/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDs_mgmt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LEDs_mgmt.tcl -notrace
